...
import { User, Mail, LogOut, Moon, Sun, Bell, Shield } from 'lucide-react'
        ...
        <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-100 dark:border-slate-800 overflow-hidden">
          <div className="flex items-center gap-3 px-4 py-3.5 border-b border-slate-100 dark:border-slate-800">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-slate-800 dark:text-slate-200">{user?.email ?? 'N/A'}</p>
            </div>
          </div>
          <div className="flex items-center gap-3 px-4 py-3.5 border-b border-slate-100 dark:border-slate-800">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-slate-800 dark:text-slate-200 font-mono">{user?.id?.slice(0, 12) ?? 'N/A'}...</p>
            </div>
          </div>
          <div className="flex items-center gap-3 px-4 py-3.5">
            <Bell size={16} className="text-slate-400" />
            <div>
              <p className="text-[10px] text-slate-400 uppercase">Last Synced</p>
              <p className="text-sm font-medium text-slate-800 dark:text-slate-200">
                {lastSynced ? lastSynced.toLocaleTimeString() : 'Not synced yet'}
              </p>
            </div>
          </div>
        </div>
