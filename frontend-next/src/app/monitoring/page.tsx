...
import { deriveRisk, RISK_CONFIG } from '@/lib/utils/risk'
import { formatCurrency } from '@/lib/utils/currency'
import { deriveOutstanding } from '@/lib/utils/risk'
...
function LiveMap({ cases }: { cases: CaseRow[] }) {
  ...
  useEffect(() => {
    ...
    import('leaflet').then(L => {
      ...
      const casesWithCoords = cases.filter(c => c.latitude && c.longitude)
